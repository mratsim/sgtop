...
/// TTFT plot (left of the latency row's two plots): p95 shaded, p50 as a line
/// over it, in seconds. The table's row subtitle repeats the pair gloss.
